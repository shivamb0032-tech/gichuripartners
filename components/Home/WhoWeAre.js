      ...
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col items-stretch lg:flex-row">
          ...
          >
            ...
            <p className="mb-4 text-base leading-relaxed text-stone-700 sm:text-md">
          ...
          >
            <div className="overflow-hidden shadow-2xl h-72 sm:h-96 lg:h-full min-h-64 rounded-2xl ring-4 ring-[#273277] group">
              <img

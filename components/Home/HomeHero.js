  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 px-2 bg-white"
      >
...
export default function HomeHero() {
  ...
  return (
    <section className="relative bg-[#0a0f2e] overflow-hidden flex flex-col items-center justify-center px-4 py-12 lg:min-h-screen">
          ...
          <div className="bg-white rounded-xl px-6 py-6 sm:px-8 sm:py-7 shadow-[0_4px_24px_rgba(0,0,0,0.12)]">
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 gap-3 mb-3 sm:grid-cols-3">
                ...
                <div className="flex overflow-visible bg-white border border-gray-200 rounded-lg focus-within:ring-2 focus-within:ring-[#273277]/30">
                  <div className="flex items-center px-1 bg-white border-r border-gray-200 rounded-l-lg">
                    <CountryCodeDropdown
              ...
              <div className="grid grid-cols-1 sm:grid-cols-[1.4fr_1fr] gap-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 px-4 text-sm font-bold tracking-widest uppercase text-white rounded-lg bg-gradient-to-r from-[#D81141] to-[#273277] hover:from-[#273277] hover:to-[#D81141] shadow-lg shadow-orange-400/30 transition-all duration-200 hover:scale-[1.02] active:scale-95 whitespace-nowrap disabled:opacity-70 disabled:cursor-not-allowed"
                >
      ...
      <div className="relative w-full max-w-6xl px-0 mt-4 z-1">

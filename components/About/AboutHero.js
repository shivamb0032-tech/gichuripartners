  ...
  return (
    <section className="relative bg-[#0a0f2e] overflow-hidden flex flex-col items-center justify-center px-4 py-12 lg:min-h-screen">
      ...
      <div className="relative z-10 px-2 mb-5 text-center">
        ...
        <p className="max-w-4xl mx-auto mt-3 text-sm text-gray-300 sm:text-base ">
          We help businesses build long-term success with our Tax Advisory,  Accounting, Auditing, Bookkeeping, Payroll and Business registration services.
        </p>
      </div>

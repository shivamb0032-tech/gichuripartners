        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-8 lg:px-16 py-32 w-full">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed mb-10 max-w-xl text-slate-300">
                Are you looking for the best auditing services in Kenya? We
                offer professional audit and assurance services, including
                statutory, project, forensic, tax, and due diligence audits.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                <Link
                  href="/"
                  className="flex items-center gap-2 text-white font-semibold px-8 py-4 rounded-xl text-sm shadow-lg"
                  style={{
                ...
                {/* <Link
            href="/services"
            className="flex items-center gap-2 font-semibold px-8 py-4 rounded-xl text-sm border text-indigo-300 border-indigo-300/30"
          >
            View All Services
          </Link> */}
              </div>
